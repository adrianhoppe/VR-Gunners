...
namespace BeardedManStudios.Forge.Networking.Unity
{
	public partial class NetworkManager : MonoBehaviour
	{
		...
		public GameObject[] GenericNetworkNetworkObject = null;
		...
		private void CaptureObjects(NetworkObject obj)
		{
			...
			else if (obj is GenericNetworkNetworkObject)
			{
				MainThreadManager.Run(() =>
				{
					NetworkBehavior newObj = null;
					if (!NetworkBehavior.skipAttachIds.TryGetValue(obj.NetworkId, out newObj))
					{
						if (GenericNetworkNetworkObject.Length > 0 && GenericNetworkNetworkObject[obj.CreateCode] != null)
						{
							var go = Instantiate(GenericNetworkNetworkObject[obj.CreateCode]);
							newObj = go.GetComponent<GenericNetworkBehavior>();
						}
					}
		...
		[Obsolete("Use InstantiateGenericNetwork instead, its shorter and easier to type out ;)")]
