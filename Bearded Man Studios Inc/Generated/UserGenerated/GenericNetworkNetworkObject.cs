...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class GenericNetworkNetworkObject : NetworkObject
	{
		...
		public GenericNetworkNetworkObject() : base() { Initialize(); }
		public GenericNetworkNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public GenericNetworkNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
